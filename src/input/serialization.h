...
namespace laprem::input {
    ...
    void to_json(nlohmann::json &j, const struct input_event &e) {
        j = nlohmann::json{{"time_s",  e.time.tv_sec},
                           {"time_us", e.time.tv_usec},
                           {"type",    e.type},
                           {"code",    e.code},
                           {"value",   e.value}};
    }
    ...
    NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(device_info, name,
                                       bus_type,
                                       vendor,
                                       product,
                                       version,
    ...
    NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(device_descriptor, unique,
                                       logical_location,
                                       physical_location,
                                       nickname,
                                       device_identifier,
