...
namespace laprem::input {
    ...
    typedef enum bus_types : uint16_t {
        BUS_PCI = 0x01,
        BUS_ISAPNP = 0x02,
        BUS_USB = 0x03,
        BUS_HIL = 0x04,
    ...
    typedef enum event_types : uint16_t {
        EV_SYN = 0x00,
        EV_KEY = 0x01,
        EV_REL = 0x02,
        EV_ABS = 0x03,
    ...
    typedef struct event_code {
        typedef enum syn : uint16_t {
            SYN_REPORT = 0,
            SYN_CONFIG = 1,
            SYN_MT_REPORT = 2,
            SYN_DROPPED = 3,
